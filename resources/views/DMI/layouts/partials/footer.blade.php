            ...
            <div
                ...
                <ul class="list-unstyled text-sm-start">
                    @forelse ($kontak as $kontak)
                        <li class="py-md-1"><i class="fas fa-envelope"></i>
                            <a class="link-light ms-2 text-decoration-none"
                                style="font-size: 12px;">inkindo.yogyakarta@gmail.com
                            </a>
                        </li>
                        {{-- <li class="py-md-1"><i class="fas fa-envelope"></i>
                            <a class="link-light ms-2 text-decoration-none"
                                style="font-size: 12px;">{{ $kontak->email }}
                            </a>
                        </li> --}}
                        {{-- <li class="py-md-1"><i class="fas fa-phone-alt"></i>
                            <a class="link-light ms-2 text-decoration-none" style="font-size: 12px;">
                                {{ $kontak->no_hp }}
                            </a>
                        </li> --}}
                        <li class="py-md-1"><i class="fas fa-phone-alt"></i>
                        ...
                        {{-- <li class="py-md-1"><i class="fas fa-map-marked"></i><a class="link-light ms-2 text-decoration-none"
                            href="#" style="font-size: 12px;">{{$kontak->alamat}}</a>
                        </li> --}}
                        <li class="py-md-1"><i class="fas fa-map-marked"></i><a
                                class="link-light ms-2 text-decoration-none" href="#" style="font-size: 12px;">jl.
                                Godean KM.5 Nogosaren Baru No.32, Banyuraden, Gamping Sleman Yogyakarta 55293</a>
                        </li>
                    @empty
            ...
            <div
                ...
                <ul class="list-unstyled d-flex flex-row flex-sm-row flex-md-row">
                    @forelse ($medsos as $medsos)
                        <li class="me-2"><a href="https://www.facebook.com/inkindojogja"><i
                                    class="fab fa-facebook text-white" style="color: rgb(13, 110, 253);"></i></a></li>
                        <li class="me-2"><a
                                href="https://www.instagram.com/inkindojogja/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA=="><i
                                    class="fab fa-instagram text-white" style="color: rgb(13, 110, 253);"></i></a></li>
                        {{-- <li class="me-2"><a href="#"><i class="fab fa-twitter text-white"
                                    style="color: rgb(13, 110, 253);"></i></a></li> --}}
                        {{-- <li class="me-2"><a href="https://wa.me/+6282329564648"><i class="fab fa-whatsapp text-white"
                                    style="color: rgb(13, 110, 253);"></i></a></li> --}}
                    @empty
                        <li class="me-2"><a href="https://www.facebook.com/inkindojogja"><i
                                    class="fab fa-facebook text-white" style="color: rgb(13, 110, 253);"></i></a></li>
