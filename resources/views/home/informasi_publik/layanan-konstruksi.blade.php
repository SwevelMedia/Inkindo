...
@section('title', 'Layanan Konstruksi')
...
@section('content')
    <section class="py-5" style="background: #0a425c; font-family: Poppins, sans-serif;">
        <div class="container my-3" style="text-align: center;">
            ...
            <div class="row">
                <div class="col-md-12 d-xl-flex justify-content-xl-center mt-md-4"><input
                        class="form-control-sm mt-md-0 pt-md-2 pb-md-2 pe-md-5 ps-md-4" type="search"
                        placeholder="cari bidang jasa"
                        style="border-radius: 30px;border-color: #ffffff;width: 356px;" /><button
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <h4 class="mb-0 fw-semibold">Klasifikasi Bidang Konstruksi</h4>
                        ...
                        <div class="list-group my-4">
                            ...
                            @foreach ($kategori1 as $item)
                                <button type="button" id="v-pills-first-tab"
                                    class="list-group-item list-group-item-action active mb-4" aria-current="true"
                                    data-bs-toggle="pill" data-bs-target="#v-pills-first" type="button" role="tab"
                                    style="border-radius: 10px;"><img class="me-3"
                                        src="{{ asset('assets/img/architect 1.png') }}" style="width: 50px;height: 50px;">
                                    {{$item->nama_kalsifikasi_konstruksi}}</button>
                            @endforeach

                            <!-- tab-2 -->
                            {{-- <button type="button" id="v-pills-second-tab"
                                class="list-group-item list-group-item-action mb-4" data-bs-toggle="pill"
                                data-bs-target="#v-pills-second" style="border-radius: 10px;"><img class="me-3"
                                    src="{{ asset('assets/img/architect 1.png') }}"
                                    style="width: 50px;height: 50px;">Kategroi 2</button>

                            <!-- tab-3 -->
                            <button type="button" id="v-pills-third-tab"
                                class="list-group-item list-group-item-action mb-4" data-bs-toggle="pill"
                                data-bs-target="#v-pills-third" style="border-radius: 10px;"><img class="me-3"
                                    src="{{ asset('assets/img/architect 1.png') }}"
                                    style="width: 50px;height: 50px;">Kategroi 3</button>

                            <!-- tab-4 -->
                            <button type="button" id="v-pills-fourth-tab"
                                class="list-group-item list-group-item-action mb-4" data-bs-toggle="pill"
                                data-bs-target="#v-pills-fourth" style="border-radius: 10px;"><img class="me-3"
                                    src="{{ asset('assets/img/architect 1.png') }}"
                                    style="width: 50px;height: 50px;">Kategroi 4</button> --}}
                        </div>
                    </ul>
                </div>
