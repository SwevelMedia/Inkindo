...
@section('content')
    <section class="py-5" style=" background: url('{{ asset('assets/img/backgorund-navbar.svg') }}');">
        <div class="container my-3" style="text-align: center;">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-white fw-bold text-heeader-nonkonstruksi" style="font-size: 30px;">Bidang dan Layanan
                        Non Sertifikasi
                    </h1>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="search col-md-12 d-xl-flex justify-content-xl-center mt-md-4">
                        <input id="search-data-input"
                            ...
                            placeholder="cari non sertifikasi yang anda inginkan" style="border-radius: 30px;width: 40%;" />
                    </div>
                                ...
                                <div>
                                    <button type="button" id="v-pills-first-tab"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                {{ $kategori1->nama_klasifikasi_non_konstruksi }}
                                            </div>
                                        </div>
                                    </button>
                                </div>
                                    ...
                                    @if ($index > 0)
                                        <div>
                                            <button type="button" id="v-pills-first-tab{{ $item->id }}"
                                                ...
                                                aria-current="true" data-bs-toggle="pill"
                                                data-bs-target="#v-pills-first{{ $item->id }}" type="button"
                                                ...
                                                @if ($item->logo_dark)
                                                    <img class="me-3 logo-dark logo-active icon-kategori-1"
                                                        ...
                                                        style="width: 50px;height: 50px;">
                                                @endif{{ $item->nama_klasifikasi_non_konstruksi }}
                                            </button>
                                        </div>
                                    @endif
                                @endforeach
                                    ...
                                    <div>
                                        <button type="button" id="v-pills-first-tab{{ $item->id }}"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    {{ $item->nama_klasifikasi_non_konstruksi }}
                                                </div>
                                            </div>
                                        </button>
                                    </div>
                                    ...
                                    <div class="accordion accordion-flush" id="accordionExample">
                                        <div class="accordion-item">
                                            <div class="accordion-header" id="headingOne">
                                                @foreach ($default as $first)
                                                    <button class="accordion-button collapsed rounded shadow mt-2 mb-3"
                                                        type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#sub1{{ $first->id }}" aria-expanded="true"
                                                        aria-controls="collapseOne">
                                                        <h6 class="fw-medium">{{ $first->jenis_layanan_non_konstruksi }}
                                                        </h6>
                                                    </button>
                                                    <div id="sub1{{ $first->id }}" class="accordion-collapse collapse"
                                                        aria-labelledby="headingOne">
                                                        <div class="accordion-body">
                                                            <p>{!! $first->deskripsi_layanan_non_konstruksi !!}</p>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="headingOne">
                                                    @foreach ($kons as $value)
                                                        @if ($value->klasifikasi_non_konstruksi_id == $item->id)
                                                            <button
                                                                ...
                                                                <h6 class="fw-medium">
                                                                    {{ $value->jenis_layanan_non_konstruksi }}
                                                            </button>
                                                            <div id="sub1{{ $value->id }}"
                                                                class="accordion-collapse collapse"
                                                                aria-labelledby="headingOne">
                                                                <div class="accordion-body">
                                                                    <p>{!! $value->deskripsi_layanan_non_konstruksi !!}</p>
                                                                </div>
                                                            </div>
                                                        @endif
                                                    @endforeach
