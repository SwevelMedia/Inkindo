...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        @include('dashboard.layouts.partials.anggota-navbar')

        @include('dashboard.layouts.partials.anggota-sidebar')
