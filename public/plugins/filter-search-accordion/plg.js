    ...
    $.fn.btAcc_sf = function (options) {
        ...
        $(document).on("click", ".create_new_filter_data", function () {
            ...
            filter_container.append(
                '<i onClick="" class=" btn btn-primary  m-1"><span class="filter_data">' +
                    filter_text +
                    '</span> | <span class="btn btn-danger filter_data_close_btn">X</span></i>'
            );
            txt_filter.val("");
            system.showAll();
        });
        ...
        txt_search.keyup(function () {
            ...
            if (txt == "" || txt == null) {
                system.showAll();
                $(".tab-hide").removeClass("show active");
                $("#v-pills-first").addClass("show active");
                $(".list-group-item").removeClass("active");
